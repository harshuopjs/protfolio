window.addEventListener("DOMContentLoaded", async function () {
    ...
    document.querySelectorAll(".insta-card").forEach(async function (el) {
        const username = el.getAttribute("username");

        const response = await get(`https://www.instagram.com/users/${username}`);
        const { name, avatar_url, followers, html_url, following } = response;
